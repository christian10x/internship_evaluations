    ...
    <div className={`${styles.sidebarContainer} ${isOpen ? styles.open : ""}`}>
      ...
      <ul>
        <li>
          <Link to={`/`}>
            <div
              className={`${styles.liContainer} ${location.pathname === "/" ? styles.selected : ""}`}
        ...
        <li>
          <Link to={`/cursos`}>
            <div
              className={`${styles.liContainer} ${location.pathname === "/cursos" ? styles.selected : ""}`}
              onClick={handleLinkClick}
            >
        ...
        <li>
          <Link to={`/horario`}>
            <div
              className={`${styles.liContainer} ${location.pathname === "/horario" ? styles.selected : ""}`}
              onClick={handleLinkClick}
            >
        ...
        <li>
          <Link to={`/pagos`}>
            <div
              className={`${styles.liContainer} ${location.pathname === "/pagos" ? styles.selected : ""}`}
              onClick={handleLinkClick}
            >
